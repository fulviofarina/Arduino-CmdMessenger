...
namespace OS
{
    ...
    public class OS
    {
        ...
        private OSForm    _controllerForm;

        // ------------------ MAIN  ----------------------

        // Setup function
        public void Setup(OSForm controllerForm)
        {
            ...
            {
                CurrentSerialSettings = { PortName = "COM46", BaudRate = 115200, DtrEnable = false } // object initializer
            };
